...
if(@$_GET['act']=='vote'){
    ...
    $count=$qr->num_rows;
    if($count>0){
        //echo "<script> alert('NYANGAU HII');window.location.href='female_representatives'  </script> ";
        ...
        if(mysqli_query($conn,$sql)){
            //echo "<script> alert('IKO NDAAAAANI.....');window.location.href='female_representatives'  </script> ";
...
<?php require_once('include/header1.php')?>
        ...
        <header class="panel-heading">
            <?php echo $sch_name?> Female Representatatives
        ...
        <tr>
            ...
            INNER JOIN smartvoter.schools
                ON (departments.school_id = schools.school_id)WHERE positions.position_id=9 AND students.school_id='$school';";
