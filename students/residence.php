...
if(@$_GET['act']=='vote'){
    ...
    $count=$qr->num_rows;
    if($count>0){
        //echo "<script> alert('NYANGAU HII');window.location.href='residence'  </script> ";
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <header class="panel-heading">
                    <?php echo $reside_name?> Representatives
                        ...
                        <div class="table-responsive">
                            <table class="display table table-bordered table-striped" id="dynamic-table">
                                ...
                                INNER JOIN smartvoter.schools
                                    ON (students.school_id = schools.school_id)WHERE positions.position_id='$reside' AND
                                    students.residence_id='$reside' AND students.residence_id IN(10,11,12,13,14)
                                    ";
