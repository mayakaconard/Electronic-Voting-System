...
if(@$_GET['act']=='vote'){
    ...
    if($count>0){
        ...
        //echo "<script> alert('SORRY!! You have already voted this position.');window.location.href='sec_gen'  </script> ";
    }
    else{
        ...
        if(mysqli_query($conn,$sql)){
            ...
            //echo "<script> alert('Vote successfully casted!,,');window.location.href='sec_gen'  </script> ";
        }
        else{
...
<?php require_once('include/header1.php')?>
        ...
        <tr>
            ...
            INNER JOIN smartvoter.schools
                ON (departments.school_id = schools.school_id)WHERE positions.position_id=2";
