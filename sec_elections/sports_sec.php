...
if(@$_GET['act']=='vote'){
    ...
    if($count>0){
        ...
        //echo "<script> alert('SORRY!! You have already voted this position!');window.location.href='sports_sec'  </script> ";
    }
    else{
        ...
        if(mysqli_query($conn,$sql)){
            ...
            //echo "<script> alert('Vote successfully casted!,,');window.location.href='sports_sec'  </script> ";
        }
        else{
    ...
    <div class="wrapper">
        ...
        FROM
            ...
            INNER JOIN smartvoter.schools
                ON (departments.school_id = schools.school_id)WHERE positions.position_id=6";
