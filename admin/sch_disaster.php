...
<div class="wrapper">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <header class="panel-heading">
                    Votes Per Candidate: SCHOOL OF DISASTER MANAGEMENT AND HUMANITARIAN ASSISTANCE: MALE REPS
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <header class="panel-heading">
                    Votes Per Candidate: SCHOOL OF DISASTER MANAGEMENT AND HUMANITARIAN ASSISTANCE: FEMALE REPS
            <span class="tools pull-right">
                <a href="javascript:;" class="fa fa-chevron-down"></a>
             </span>
                </header>
