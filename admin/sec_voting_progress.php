                    ...
                    <div class="table-responsive">
                        <div class="">
                            <table  class="display table table-bordered table-striped" id="dynamic-table">
                                ...
                                ,schools.*
                                ,positions.*
                                ,sec_votes.candidate_id,sec_votes.school_id,sec_votes.position_id,
                                COUNT(sec_votes.candidate_id) AS kura
                                FROM students,schools,candidates,positions,sec_votes
                                WHERE
                                candidates.candidate_id=sec_votes.candidate_id AND
                                ...
                                positions.position_id IN(1,2,3,4,5,6)
                                GROUP BY sec_votes.candidate_id
                                ORDER BY positions.position_id,kura DESC";
